...
document.querySelector("#list-btn").addEventListener("click", function () {
  ...
  // let gooSel = gugunSel.options[gugunSel.selectedIndex].text;
  // let dongSel = dong.options[dong.selectedIndex].text;
...
function makeList(data) {
  ...
  viewMap(dongSel, gooSel + " " + dongSel);
  // /////////////////////
  ...
  apts.forEach((apt) => {
    if (apt.querySelector("법정동").textContent.trim() == dongSel.trim()) {
      flag = flag + 1;
      ...
      tr.addEventListener("click", () =>
        viewMap(apt.querySelector("연립다세대").textContent, address)
      );
  ...
  if (flag > 0) {
    document.querySelector("table").setAttribute("style", "display: ;");
    document
      .querySelector("#none-message")
      .setAttribute("style", "display: none;");
  } else {
    document.querySelector("table").setAttribute("style", "display: none;");
    document.querySelector("#none-message").setAttribute("style", "display:;");
  }
}
